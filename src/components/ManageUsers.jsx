...
function ManageUsers() {
    ...
    useEffect(() => {
        const fetchUsers = async () => {
            try {
                const res = await axios.get('https://brsbackendserver.onrender.com/api/users');
                setUsers(res.data);
            } catch (err) {
    ...
    const handleUpdateUser = async (updatedUser) => {
        try {
            const res = await axios.put(`https://brsbackendserver.onrender.com/api/users/${updatedUser._id}`, updatedUser, {
                headers: {
    ...
    const handleDeleteUser = async (userId) => {
        ...
        if (confirmed) {
            try {
                await axios.delete(`https://brsbackendserver.onrender.com/api/users/${userId}`);
